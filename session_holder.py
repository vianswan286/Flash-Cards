...
class Session:
    ...
    def choose_cards(self):
        ...
        new_ten -> you will see 10 cards you have not seen yet (or less if it is not possible)
        """
        if self.mode == "all":
    ...
    def show_answer(self):
        if self.check_cards() == 0:
            return
        self.current_card.update_history("failed")
